...
export const ELEMENTS_SCHEMA_CONTRACT = Object.freeze({
  ...
  [PROPERTY.section]: { type: 'select', options: ['Drive', 'Docs', 'Sheets', 'Slides'], exactOptions: true },
  [PROPERTY.fileFormat]: {
    type: 'select',
    options: ['Google Docs', 'Word', 'Google Sheets', 'Excel', 'CSV', 'Google Slides', 'PowerPoint', 'Link', 'Other File'],
    exactOptions: true
  },
  [PROPERTY.provider]: { type: 'select', options: ['Google Drive', 'External URL', 'Notion'], exactOptions: true },
  [PROPERTY.googleFileId]: { type: 'rich_text' },
  [PROPERTY.googleFolderId]: { type: 'rich_text' },
  [PROPERTY.downloadName]: { type: 'rich_text' },
  ...
  [PROPERTY.syncError]: { type: 'rich_text' },
  [PROPERTY.normalizedUrl]: { type: 'rich_text' },
  [PROPERTY.idempotencyKey]: { type: 'rich_text' },
  [PROPERTY.taskPageId]: { type: 'formula' },
  [PROPERTY.knowledgeKey]: { type: 'formula' },
  [PROPERTY.integrity]: { type: 'select', options: ['ok', 'duplicate', 'context_error', 'sync_error'], exactOptions: true },
