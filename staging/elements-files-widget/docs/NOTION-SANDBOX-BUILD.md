> **Legacy / исторический документ.** Ниже сохранён прежний план отдельного
> Notion sandbox без редактирования истории. Он не является активной
> инструкцией: текущий staging работает только с явно разрешённой основной
> data source «Элементы» по схеме canary → один шаблон.
